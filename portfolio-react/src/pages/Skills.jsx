...
const SkillsHeaderContainer = (props) => {
    ...
    return (
        <Row ref={forwardedRef} className={`skills-head d-flex flex-column align-items-center justify-content-center m-0 ${animations}`} >
            ...
            <Col className="skills-subtext text-center pt-0 p-4" xs={12} md={9} lg={7}>Here you will find more information about me, what I do, and my current skills mostly in terms of programming and technology</Col>
        </Row>
    )
}
