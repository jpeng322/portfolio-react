...
const IconContainerVP = handleViewport(IconContainer);
const IconHeaderVP = handleViewport(IconHeader);

const FirstRowIcons = () => {
  return (
    <>
      <IconHeaderVP header="Languages" />
      <div className="d-flex flex-column flex-md-row flex-xl-column flex-xxl-row justify-content-center flex-grow">
        <div className="icon-row d-flex text-center m-0 gap-3 p-2">
          <IconContainerVP
            svgInfo={
